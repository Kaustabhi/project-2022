...
const Items = [
  ...
  {image: "cholasamosachatsb.jpg",
  name: "Chola Samosa Chat",
  price: "₹40"
  },
  {
    image: "vegrollsb.jpg",
...
export default function bhaduriyamedicalstore() {
  return (<Layout>
  <div className="container text-center py-5">
      <h2 className="pb-2 border-bottom text-center">Bhaduriya Medical Store</h2>
